...
def benchmark(name, link, seed=0):
    ...
    for e in range(1, 31):
        ...
        trainer = InceptionTimeClassifier(
            n_epochs=1500, depth=3, kernel_size=[10, 20, 40], random_state=seed
        )
...
results_file = "results_inception.txt"
...
try:
    ...
    mean, std = benchmark(dataset_name, dataset_link, seed=seed)
